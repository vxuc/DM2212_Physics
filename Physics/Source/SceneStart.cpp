...
/*
void SceneStart::SplitAsteroid(GameObject* go)
{
...
void SceneStart::SpawnPowerUp(GameObject* go, float rng)
{
...
void SceneStart::UpdatePowerUp(double dt)
{
...
void SceneStart::UpdateKeyInputs(double dt)
{
...
*/
void SceneStart::UpdateMouseInputs(double dt)
{
	//Mouse Section
...
/*
void SceneStart::UpdateCamera(double dt)
{
	//move camera pos
...
bool SceneStart::LevelOne(double dt)
{
...
bool SceneStart::LevelOneBonus(double dt)
{
...
void SceneStart::RenderCustomisationMenu()
{
...
void SceneStart::RenderGO(GameObject *go)
{/*
	if (go->isHit)
	{

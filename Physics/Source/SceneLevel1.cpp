...
void SceneLevel1::SplitAsteroid(GameObject* go)
{
...
void SceneLevel1::SpawnPowerUp(GameObject* go, float rng)
{
...
void SceneLevel1::UpdatePowerUp(double dt)
{
...
void SceneLevel1::UpdateKeyInputs(double dt)
{
	m_force.SetZero();
	m_torque.SetZero();
...
void SceneLevel1::UpdateMouseInputs(double dt)
{
	//Mouse Section
...
void SceneLevel1::UpdateCamera(double dt)
{
	//move camera pos
...
bool SceneLevel1::LevelOne(double dt)
{
...
bool SceneLevel1::LevelOneBonus(double dt)
{
